...
with st.sidebar.container(height=470, border=0):
    st.write('Donde el Magdalena deja atrás el macizo colombiano y la alta montaña, para lanzarse hacia la llanura costera del caribe y posteriormente al mar, Macondo se preparan para un nuevo "Huracán" en Honda')
